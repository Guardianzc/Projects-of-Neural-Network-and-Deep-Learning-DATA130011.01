...
class custom_dataset(data.Dataset):
	...
	def __getitem__(self, index):
		...
		# w = img.shape[1]
		# if h>=w:
		# 	padding_length1 = int((h-w)//2)
		# 	padding_length2 = h-w-padding_length1
		# 	padding_block1 = np.zeros((h,padding_length1,3))
		# 	padding_block2 = np.zeros((h,padding_length2,3))
		# 	img = np.concatenate((padding_block1,img,padding_block2),axis = 1)
		# 	vertices[:,0]+=padding_length1
		# 	vertices[:,2]+=padding_length1
		# 	vertices[:,4]+=padding_length1
		# 	vertices[:,6]+=padding_length1
		# else:
		# 	padding_length1 = int((w-h)//2)
		# 	padding_length2 = w-h-padding_length1
		# 	padding_block1 = np.zeros((padding_length1,w,3))
		# 	padding_block2 = np.zeros((padding_length2,w,3))
		# 	img = np.concatenate((padding_block1,img,padding_block2),axis = 0)
		# 	vertices[:,1]+=padding_length1
		# 	vertices[:,3]+=padding_length1
		# 	vertices[:,5]+=padding_length1
		# 	vertices[:,7]+=padding_length1
		# # 修改target坐标
		...
		return transform(img), score_map, geo_map, ignored_map,self.img_files[index]
